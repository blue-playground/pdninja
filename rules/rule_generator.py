...
ruleset_name_sysmon = "rules/generated_rules/rules_windows_sysmon_pysigma.json"
ruleset_name_windows = "rules/generated_rules/rules_windows_generic_pysigma.json"

def convert_rule(backend, rule):
    try: 
        return backend.convert_rule(rule, "ex_pdninja")[0]
